...
-   Scrivi un codice `R` per creare un vettore con i numeri da 1 a
    10.
...
Creare una versione di entrambe le funzioni con un parametro ulteriore
`mul` che se `TRUE` continui la ricerca una volta trovato un primo
match.
...
3)  Crea una funzione che restituisca un vettore contente solo gli
    elementi unici presenti nel vettore di input. Non usare una funzione
...
2)  Implementa una funzione che inverte l'ordine degli elementi in una
    lista.
